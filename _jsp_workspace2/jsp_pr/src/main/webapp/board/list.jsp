    ...
    <table class="table table-hover table-bordered" border="1px" style="height: 150px;">
        <tr>
          ...
          <tbody class="table-group-divider">
            ...
            <tr>
                <th scope="col" style="padding: 12px;"><a href="/brd/detail?bno=${bvo.bno }" style="color: black;">${bvo.bno }</a></th>
                <td style="padding: 12px;"><a href="/brd/detail?bno=${bvo.bno }" style="color: black;">${bvo.title }</a></td>
                <td style="padding: 12px;"><a href="/brd/detail?bno=${bvo.bno }" style="color: black;">${bvo.writer }</a></td>	
                <td style="padding: 12px;"><a href="/brd/detail?bno=${bvo.bno }" style="color: black;">${bvo.regdate }</a></td>	
                <td style="padding: 12px;"><a href="/brd/detail?bno=${bvo.bno }" style="color: black;">${bvo.moddate }</a></td>	
                <td style="padding: 12px;"><a href="/brd/detail?bno=${bvo.bno }" style="color: black;">${bvo.readcount }</a></td>	
